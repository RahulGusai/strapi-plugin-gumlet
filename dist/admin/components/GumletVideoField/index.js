...
const Field_2 = require('@strapi/design-system/Field');
const GumletVideoField = ({ name, error, attribute }) => {
  const { modifiedData, onChange } = (0,
  helper_plugin_1.useCMEditViewDataManager)();
  ...
  (0, react_1.useEffect)(() => {
    const fetchGumletAssets = () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (
          assetId &&
          !gumletAssets.some((asset) => asset.videoId === assetId)
        ) {
          setAssetId('');
        }
      });
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(
        Field_2.FieldLabel,
        null,
        'Filter For Gumlet Video'
      ),
      react_1.default.createElement(Field_2.FieldInput, {
        type: 'text',
      ...
      react_1.default.createElement(
        ...
        filteredAssets.map((asset) =>
          react_1.default.createElement(
            design_system_1.Option,
            { key: asset.videoId, value: asset.videoId },
            asset.title
          )
        )
      )
