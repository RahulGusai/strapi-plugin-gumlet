...
const GumletVideoField = ({ name, error, attribute, }) => {
    ...
    return (react_1.default.createElement(Field_1.Field, { name: name, id: name, error: error },
        react_1.default.createElement(design_system_1.Combobox, { "aria-label": "Gumlet Video", value: assetId || '', onChange: (value) => {
                handleChange({ assetId: value });
            } }, videoAssets.map((asset, i) => (react_1.default.createElement(design_system_1.ComboboxOption, { key: asset.videoId, value: asset.videoId }, asset.title)))),
