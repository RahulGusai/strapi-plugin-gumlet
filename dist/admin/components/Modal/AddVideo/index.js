...
const react_dropbox_chooser_1 = __importDefault(
  require('react-dropbox-chooser')
);
const AddVideoModal = ({ update, close }) => {
  ...
  const handleChange = (event) => {
    ...
    setInputData((prevInputData) =>
      Object.assign(Object.assign({}, prevInputData), { [name]: value })
    );
  };
  const updateCollectionId = (collectionId) => {
    setInputData(
      Object.assign(Object.assign({}, inputData), {
  ...
  const handleRemoveTag = (tag) => {
    ...
    setInputData(
      Object.assign(Object.assign({}, inputData), { tags: newTags })
    );
  };
  ...
  const handleRemoveMetadata = (metadata) => {
    const newMetadata =
      ...
      (inputData === null || inputData === void 0
        ? void 0
        : inputData.metadata.filter((m) => m !== metadata));
    setInputData(
      Object.assign(Object.assign({}, inputData), { metadata: newMetadata })
    );
  };
  const onFileSelected = (file) => {
    ...
    setFile(file);
    setInputData((prevInputData) =>
      Object.assign(Object.assign({}, prevInputData), {
  ...
  const renderUploadMethod = () => {
    if (uploadMethod === 'file') {
      return react_1.default.createElement(importZone_1.default, {
      ...
      return react_1.default.createElement(
        ...
        react_1.default.createElement(
          ...
          react_1.default.createElement(Field_1.FieldInput, {
      ...
      return react_1.default.createElement(
        ...
        react_1.default.createElement(
          ...
          react_1.default.createElement(
            react_dropbox_chooser_1.default,
            {
              appKey: dropbox_1.DROPBOX_CLIENT_ID,
  ...
  return react_1.default.createElement(
    ModalLayout_1.ModalLayout,
    { onClose: close, labelledBy: 'title' },
    react_1.default.createElement(
      ModalLayout_1.ModalHeader,
      null,
      react_1.default.createElement(
        Typography_1.Typography,
        { fontWeight: 'bold', textColor: 'neutral800', as: 'h2', id: 'title' },
        'Upload a video'
      )
    ),
    react_1.default.createElement(
      ModalLayout_1.ModalBody,
      null,
      renderUploadMethod(),
      react_1.default.createElement(Fields_1.default, {
        name: 'title',
        label: 'Title',
        value: title,
      ...
      react_1.default.createElement('br', null),
      react_1.default.createElement(CollectionId_1.default, {
        name: 'Collection Id',
      ...
      react_1.default.createElement('br', null),
      react_1.default.createElement(Tags_1.default, {
        handleSetTag: handleSetTag,
        handleRemoveTag: handleRemoveTag,
        tags: tags || [],
        editable: true,
      }),
      react_1.default.createElement(Metadata_1.default, {
        metadata: metadata,
    ...
    react_1.default.createElement(ModalLayout_1.ModalFooter, {
      startActions: react_1.default.createElement(
        Button_1.Button,
        { onClick: close, variant: 'tertiary' },
        'Cancel'
      ),
      endActions: react_1.default.createElement(
        react_1.default.Fragment,
        null,
        react_1.default.createElement(UploadButton_1.default, {
